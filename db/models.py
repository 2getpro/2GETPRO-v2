...
class User(Base):
    ...
    balance_kopeks = Column(Integer, default=0, nullable=False)
...
class Transaction(Base):
    """Модель для хранения истории транзакций пользователей"""
    ...
    def __repr__(self):
        return f"<Transaction(id={self.id}, user_id={self.user_id}, amount={self.amount_kopeks}, type='{self.transaction_type}')>"