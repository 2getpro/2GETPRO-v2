...
class Settings(BaseSettings):
    ...
    REDIS_TTL: int = Field(default=3600, description="Default TTL for cache entries in seconds")
    ...
    WEBHOOK_VALIDATION_ENABLED: bool = Field(default=True)
    WEBHOOK_SECRET_TOKEN: Optional[str] = Field(default=None)
